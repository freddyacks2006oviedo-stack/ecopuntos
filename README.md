[como usarios originales.html](https://github.com/user-attachments/files/31049455/como.usarios.originales.html)
<!DOCTYPE html>
<!DOCTYPE html>
<html lang="es">
...
<title>EcoPuntos - Usuarios</title>
...
<header>
    ...
    <p>
        Recicla, gana puntos y conviértelos en soles
    </p>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="residuos">
                ...
                <div
                class="residuo"
                onclick="seleccionarResiduo(this,'Plástico',100)">
                ...
                <div
                class="residuo"
                onclick="seleccionarResiduo(this,'Cartón',80)">
                ...
                <div
                class="residuo"
                onclick="seleccionarResiduo(this,'Papel',70)">
                ...
                <div
                class="residuo"
                onclick="seleccionarResiduo(this,'Vidrio',120)">
        ...
        <div class="card">
            ...
            <button
            class="btn-naranja btn-completo"
